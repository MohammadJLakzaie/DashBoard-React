        ...
        <div className="w-full max-w-lg sm:max-w-xl rounded-xl bg-white shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-start justify-between gap-4 border-b border-gray-200 px-5 py-4 sm:px-6">
            ...
            <Buttons
              ...
              name="خروج"
              width="shrink-0"
              color="text-gray-600 hover:bg-gray-100 hover:text-gray-800 "
            />
          </div>
          ...
          <div className="px-5 py-4 sm:px-6 space-y-5 overflow-auto">
            <div>
              ...
              <textarea
                value={description}
                onChange={(event) => {
                  (setDescription(event.target.value), setActive(false));
                }}
                placeholder="تسک خود را اینجا شرح دهید"
                className="block w-full h-48 px-4 py-3 text-gray-900 border border-gray-300 rounded-xl bg-gray-50/50 focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-smooth text-right"
              />
            </div>
          </div>
