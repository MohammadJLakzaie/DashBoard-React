  ...
  <div className="w-full max-w-md bg-white rounded-2xl shadow-card overflow-hidden transition-all duration-300 hover:shadow-2xl">
    <div className="px-6 py-8 sm:px-8 sm:py-10">
      <div className="flex justify-start items-center gap-2 mb-6">
        ...
        <span className="text-xl font-semibold tracking-tight text-gray-800">Your Logo</span>
      </div>

      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-gray-900">Sign Into<br />Your Account</h1>
        <div className="mt-2 h-1 w-12 bg-indigo-500 rounded-full"></div>
      </div>

      <form id="signinForm" className="space-y-6" action="#" method="POST">
        <div>
          <label htmlFor="company-id" className="block text-sm font-semibold text-gray-700 mb-1.5">Company ID</label>
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <label htmlFor="remember-me" className="text-sm font-medium text-gray-700 cursor-pointer select-none">Remember Me</label>
        </div>
